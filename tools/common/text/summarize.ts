...
export async function summarize(
  ...
  const prompt = `Write a concise SEO meta description of maximum ${maxLength} characters for
    the following content. Write it in language specified by 2-letter code - ${lang}. Dont use diacritics, use simplified versions for sanskrit words. Print just the description without explanation or words count. Content:`;
